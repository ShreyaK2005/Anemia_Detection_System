...
input_path = "combined_images_dataset"

# Output dataset (cropped images)
...
def crop_conjunctiva(img):
    ...
    # =========================
    # 🔥 STEP 5: SMART FALLBACK (CENTER OF EYE REGION)
    # =========================
    h_e, w_e = eye_crop.shape[:2]
...
for cls in classes:
    ...
    for img_name in os.listdir(folder):
        ...
        save_path = os.path.join(output_path, cls, img_name)
